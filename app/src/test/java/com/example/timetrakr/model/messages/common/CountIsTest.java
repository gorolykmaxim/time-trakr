...
public class CountIsTest {

    @Test
    public void test() {
        Condition<List<Object>> condition = new CountIs<>(2);
        // Condition should apply to the list with a size equal to the specified one.
        List<Object> objectList = Arrays.asList(new Object(), new Object());
        Assert.assertTrue(condition.appliesTo(objectList));
        // Condition should not apply to the list with a size greater than the specified one.
